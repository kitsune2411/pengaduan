  ...
  <?php 
				if(isset($_GET['pesan'])){
					if($_GET['pesan']=="daftar"){
						echo "<div class='alert alert-success' role='alert'>Akun berhasil dibuat<span onclick=\"this.parentElement.style.display='none'\" style='float:right; cursor:pointer;'>X</span></div>";
					}
          elseif($_GET['pesan']=="ubah"){
						echo "<div class='alert alert-success' role='alert'>Akun berhasil diubah<span onclick=\"this.parentElement.style.display='none'\" style='float:right; cursor:pointer;'>X</span></div>";
					}
          elseif($_GET['pesan']=="hapus"){
						echo "<div class='alert alert-success' role='alert'>Akun berhasil dihapus<span onclick=\"this.parentElement.style.display='none'\" style='float:right; cursor:pointer;'>X</span></div>";
					}
          else{
