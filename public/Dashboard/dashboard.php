...
<link rel="stylesheet" href="style3.css">
    ...
    <section class="jumbotron text-center">
      ...
      <a href="#team"><i class="fas fa-chevron-down" style="font-size:75px; color:coral"></i></a>
            ...
            <div class="col-4">
              <div class="card text-center ">
                ...
                <div class="card-body">
                    ...
                    <a href="../Form pengaduan/pengaduan.php" class="btn btn-warning">VIEW MORE</a>
                </div>
              </div>
            </div>
            <div class="col-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="../Profile/profile.php" class="btn btn-warning">VIEW MORE</a>
                </div>
              </div>
            </div>
            <div class="col-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="../Profile/form-edit-profile.php" class="btn btn-warning">VIEW MORE</a>
                </div>
              </div>
            </div>
          </div>
