<?php $judul="Profil"; include "../templates/header.php"; include "../core.php"; $username = $_SESSION['username']; ?>
...
<div class="container mt-5" style="border: 3px solid #F7882F ; border-radius:15px; width:50%">
    ...
    <tr style="border-bottom: 3px solid #F7882F;" >
        <th scope="row" class="py-4">NIK</th>
        <td class="py-4"><?= $row['nik'];?></td>
